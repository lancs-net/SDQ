...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def switch_features_handler(self, ev):
        ...
        self.add_flow(datapath, 1, match, actions, timeout=0)
    ...
    def add_flow(self, datapath, priority, match, actions, buffer_id=None, timeout=0):
        ...
        if buffer_id:
            mod = parser.OFPFlowMod(datapath=datapath, buffer_id=buffer_id,
                                    ...
                                    instructions=inst, table_id=100, idle_timeout=timeout, hard_timeout=timeout)
        else:
            mod = parser.OFPFlowMod(datapath=datapath, priority=priority,
                                    match=match, instructions=inst, table_id=100, idle_timeout=timeout, hard_timeout=timeout)
        print('MOD: ', mod)
